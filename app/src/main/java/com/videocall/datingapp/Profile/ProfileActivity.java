...
import com.videocall.datingapp.Extra.EventClass;
import com.videocall.datingapp.Extra.ImageClass;
...
import com.videocall.datingapp.Settings.ReportActivity;
...
import com.videocall.datingapp.sinchex.videocalling.CallScreenActivity;
...
public class ProfileActivity extends SinchBaseActivity implements SinchServiceNew.StartFailedListener {
    ...
    FloatingActionButton floatingActionButtonVideoCall;
    FloatingActionButton floatingActionButtonAudioCall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButtonAudioCall = findViewById(R.id.floatingActionButtonAudioCall);

        imageViewProfileImage = findViewById(R.id.imageViewProfileImage);



        if (ContextCompat.checkSelfPermission(ProfileActivity.this, android.Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED ||
                ContextCompat.checkSelfPermission(ProfileActivity.this, android.Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED ||
                ContextCompat.checkSelfPermission(ProfileActivity.this, android.Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED ||
        ...
        if (firebaseUser.getUid()==profileUser){
            floatingActionButtonVideoCall.setVisibility(View.GONE);
            floatingActionButtonAudioCall.setVisibility(View.GONE);
        }
        ...
        floatingActionButtonChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Application.isHavePremium(premiumCurrent,ProfileActivity.this)){
                    return;
                }
        ...
        floatingActionButtonVideoCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                try {
                    Call call = getSinchServiceInterface().callUserVideo(profileUser);
                    if (call == null) {
                    ...
                    Intent callScreen = new Intent(ProfileActivity.this, CallScreenActivity.class);
                    callScreen.putExtra(SinchServiceNew.CALL_ID, callId);
                    callScreen.putExtra("final_UUID", final_UUID);
                    callScreen.putExtra("final_name", final_name);
                    callScreen.putExtra("final_image_url", final_image_url);

                    startActivity(callScreen);
                } catch (MissingPermissionException e) {
                    Log.e("sinch err : ","permission : "+e.getMessage());
                    ActivityCompat.requestPermissions(ProfileActivity.this,
        ...
        floatingActionButtonAudioCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // profileUser
                if (!Application.isHavePremium(premiumCurrent,ProfileActivity.this)){
                ...
                try {
                    Call call = getSinchServiceInterface().callUser(profileUser);
                    if (call == null) {
                        Toast.makeText(ProfileActivity.this,
                                "Service is not started. Try stopping the service and starting it again before "
                                + "placing a call.", Toast.LENGTH_LONG).show();
                            ...
                            if (block_stranger != null && block_stranger.equals("yes") && stringChats.equals("no")) {
                                floatingActionButtonChat.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        Toast.makeText(ProfileActivity.this,
                                                "User has privacy restrictions enabled so you can't contact this user now!",
                                                Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                ...
                .addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                        if (documentSnapshot != null) {
                            ...
                            final_UUID=profileUser;
                            final_name=user_name;
                            final_image_url=user_image;
