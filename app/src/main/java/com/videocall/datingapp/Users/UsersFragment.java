package com.videocall.datingapp.Users;
...
import com.videocall.datingapp.Loves.LovesClass;
...
public class UsersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        roomEdt=view.findViewById(R.id.roomEdt);
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        ...
                        if (stringShowGender != null) {
                            ...
                            if (stringUserGender !=null && stringUserGender.equals("Male")) {
                                stringCheckGender = "Female";
