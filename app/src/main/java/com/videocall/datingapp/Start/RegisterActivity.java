...
import com.videocall.datingapp.Extra.DateClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegisterPageRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValidPassword(editTextRegisterPassword.getText().toString())) {
                                ...
                                firebaseAuth.createUserWithEmailAndPassword(stringEmail, stringPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            userProfile.put("user_premium","no");
...
//                        Toast.makeText(RegisterActivity.this, "Please turn on Location service to continue.", Toast.LENGTH_SHORT).show();
    ...
    private Boolean isValidPassword(String value) {
        if (value.length()<7) {
            Toast.makeText(RegisterActivity.this, "Password must be have 7 characters or digits.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        if (year > 2000) {
            Toast.makeText(this,
                    "Sorry! you do not meet our user registration minimum age limits policy now. Please register with us after some time. Thank you for trying our app now!",
            ...
            textViewRegisterBirthday.setText("01-01-1980");
